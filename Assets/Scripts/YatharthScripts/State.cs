...
public class State
{
    ...
    //visible distance for enemy character
    [SerializeField] private float visDist = 10.0f;
    [SerializeField] private float visAngle = 30.0f;
    [SerializeField] private float shootDist = 7.0f;
